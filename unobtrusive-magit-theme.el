...
(let ()
  (custom-theme-set-faces
   ...
   `(magit-section-heading-secondary-heading	((t (:inherit header-line :weight bold))))
   `(magit-section-highlight			((t (:inherit highlight))))

   `(magit-diff-file-heading			((t (:inherit diff-file-header))))
   `(magit-diff-file-heading-highlight		((t (:inherit diff-file-header :inverse-video t))))
   `(magit-diff-file-heading-selection		((t (:inherit diff-file-header :weight bold))))

   `(magit-diff-hunk-heading			((t (:inherit diff-hunk-header))))
   `(magit-diff-hunk-heading-highlight		((t (:inherit diff-hunk-header :inverse-video t))))
   `(-diff-hunk-heading-selection		((t (:inherit diff-hunk-header :weight bold))))
   `(magit-diff-hunk-region			((t (:inherit default))))

   `(magit-diff-lines-boundary			((t (:inherit default))))
   `(magit-diff-lines-heading			((t (:inherit diff-header))))
   ...
   `(magit-diff-base-highlight			((t (:inherit ediff-current-diff-Ancestor :weight bold))))
   ...
   `(magit-sequence-stop			((t (:inherit warning :weight bold))))
   ...
   `(magit-refname-stash			((t (:inherit change-log-list :weight bold))))
   `(magit-refname-wip				((t (:inherit change-log-list :inverse-video t))))

   `(magit-branch-local				((t (:inherit log-view-message))))
   `(magit-branch-current			((t (:inherit log-view-message :weight bold))))
   `(magit-branch-remote			((t (:inherit log-view-message :inverse-video t))))
   `(magit-branch-remote-head			((t (:inherit log-view-message :weight bold :inverse-video t))))
   `(magit-branch-upstream			((t (:inherit log-view-message :underline t))))
   ...
   `(magit-signature-expired-key		((t (:inherit warning :weight bold))))
   `(magit-signature-good			((t (:inherit success))))
   `(magit-signature-revoked			((t (:inherit warning :inverse-video))))
   `(magit-signature-untrusted			((t (:inherit warning :weight bold :inverse-video t))))
   ...
   `(magit-reflog-amend				((t (:inherit log-view-message :inverse-video t))))
   `(magit-reflog-merge				((t (:inherit log-view-message :weight bold))))
   `(magit-reflog-checkout			((t (:inherit log-view-message :weight bold :inverse-video t))))
